#ifndef BPNEXPACTGOADAPTER_H
#define BPNEXPACTGOADAPTER_H
...
class BPNExpActGoAdapter : public BPNGoAdapterInterface
{
	private:
	...
	public:
		...
		BPNExpActGoAdapter(BPN* tempBpn, int sourceType) : BPNGoAdapterInterface(tempBpn)
		{
