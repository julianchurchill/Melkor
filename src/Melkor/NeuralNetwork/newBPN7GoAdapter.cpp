...
bool newBPN7GoAdapter::getInput(int x, int y, const BoardStruct& b, Matrix<float>& input, int colour) const
{
...
void newBPN7GoAdapter::setPoint(Matrix<float>& m, int y, int value) const
{
