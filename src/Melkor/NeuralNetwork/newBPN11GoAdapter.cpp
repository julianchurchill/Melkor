...
bool newBPN11GoAdapter::getInput(int x, int y, const BoardStruct& b, Matrix<float>& input, int colour) const
{
	...
	// 4 units per point + 2 units for distance to nearest board edges
...
void newBPN11GoAdapter::setPoint(Matrix<float>& m, int y, int value) const
{
	m.setValue(0, y*4, 0);
